  ...
  <form method="POST" action="{{ route('login') }}">
      ...
      <div class="or-sign-in-with">
        ...
        <div class="be-part-of-us">
          <span class="dont-have-account-yet">Don't have account yet? <a href="{{url('signup_influencer')}}">Register now</a></span><br>
          <span class="influencer-login">Switch to brand? <a href="{{ url('login_brand') }}">Login here</a></span>
        </div>
